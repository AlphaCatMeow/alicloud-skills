...
- Save normalized request payloads, detected face boxes, selected template ID, and task polling snapshots under `output/alicloud-ai-video-emoji/`.
...
- Default output: `output/alicloud-ai-video-emoji/request.json`

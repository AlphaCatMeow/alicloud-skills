#!/usr/bin/env python3
"""Fetch ESA OpenAPI metadata API list and save artifacts to output/."""
...
DEFAULT_PRODUCT_CODE = "ESA"
DEFAULT_VERSION = "2024-09-10"
OUTPUT_DIR = pathlib.Path("output/alicloud-network-esa")

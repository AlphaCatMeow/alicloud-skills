#!/usr/bin/env python3
"""Fetch OpenAPI metadata API list for Alibaba Cloud MPS and save to output/."""
...
DEFAULT_PRODUCT_CODE = "Mts"
DEFAULT_VERSION = "2014-06-18"
OUTPUT_DIR = pathlib.Path("output/alicloud-media-mps")

---
name: alicloud-network-cdn-test
description: Smoke test for alicloud-network-cdn. Validate minimal authentication, API reachability, and one read-only query path.
version: 1.0.0
---
...
4) Save request summary, response summary, and raw output under `output/alicloud-network-cdn-test/`.

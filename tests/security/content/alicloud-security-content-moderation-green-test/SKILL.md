...
# SECURITY CONTENT MODERATION GREEN Smoke Test

## Prerequisites

- Configure credentials with least privilege (`ALICLOUD_ACCESS_KEY_ID` / `ALICLOUD_ACCESS_KEY_SECRET` / optional `ALICLOUD_REGION_ID`).
- Target skill: `skills/security/content/alicloud-security-content-moderation-green/`.
...
python3 tests/common/compile_skill_scripts.py \
  --skill-path skills/security/content/alicloud-security-content-moderation-green \
  --output output/alicloud-security-content-moderation-green-test/compile-check.json
```
...
4) Save request summary, response summary, and raw output under `output/alicloud-security-content-moderation-green-test/`.
...
- Evidence files exist in `output/alicloud-security-content-moderation-green-test/` with timestamp and parameters.

## Result Template

- Date: YYYY-MM-DD
- Skill: skills/security/content/alicloud-security-content-moderation-green

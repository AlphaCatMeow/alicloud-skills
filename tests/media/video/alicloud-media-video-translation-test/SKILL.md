...
- Target skill: `skills/media/video/alicloud-media-video-translation/`.
...
4) Save request summary, response summary, and raw output under `output/alicloud-media-video-translation-test/`.
...
- Evidence files exist in `output/alicloud-media-video-translation-test/` with timestamp and parameters.
